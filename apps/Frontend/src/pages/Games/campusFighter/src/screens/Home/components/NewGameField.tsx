...
export function NewGameField({ onCreate }: NewGameFieldProps) {
    ...
    const [maxPlayers, setMaxPlayers] = useState(PlayersCountList[0].value as number);
    const [map, setMap] = useState(MapsList[0].value as string);
    const [mode, setMode] = useState<GameMode>(GameModesList[0].value as GameMode);
